...
def Metrics(y_true: np.ndarray, y_scores: np.ndarray) -> tuple:
...
def multi_threshold_precision_recall(y_true: np.ndarray, y_pred: np.ndarray, thresholds: np.ndarray) -> tuple:
...
def metric_summary(y_true: np.ndarray, y_pred: np.ndarray, num_thresholds: int = 10) -> tuple:
