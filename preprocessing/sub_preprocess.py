...
def preprocess_sub_disease(path: str = "data/ptb") -> Tuple[np.array]:
    ...
    y_train = np.concatenate((y1_train.diagnostic_subclass.values, y2_train.diagnostic_subclass.values), axis = 0)
    y_test = np.concatenate((y1_test.diagnostic_subclass.values, y2_test.diagnostic_subclass.values), axis = 0)
